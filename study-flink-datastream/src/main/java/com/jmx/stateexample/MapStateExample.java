...
public class MapStateExample {
    ...
    public static class UserBehaviorCnt extends RichFlatMapFunction<Tuple3<Long, String, String>, Tuple3<Long, String, Integer>> {
        ...
        StateTtlConfig ttlConfig = StateTtlConfig
                .newBuilder(Time.seconds(10)) // 指定TTL时长为10S
                .setUpdateType(StateTtlConfig.UpdateType.OnCreateAndWrite) // 只对创建和写入操作有效
                .setStateVisibility(StateTtlConfig.StateVisibility.NeverReturnExpired) // 不返回过期的数据
                .build();
